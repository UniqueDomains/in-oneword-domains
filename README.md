...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-4%2C813%20rows-8250df">
...
**Public extract:** 4,813 rows · **Live catalog:** 4,812 domains
...
- `in.csv` — public CSV extract (4,813 rows)
- `in.json` — public JSON extract (4,813 rows)
...
| ----------------------- | ------------------------------------------------ |
| 4,813-row public sample | 4,812 live domains                               |
...
> Unique Domains. *Available .IN One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
